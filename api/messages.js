...
router.post('/messages', (req, res) => {
  ...
  //Cria uma nova mensagem utilizando userId e content recebidos, uma nova data e umconst newMessage = new MessageserId, content);
  const newMessage = new Message(chatExists.messages.length + 1, userId, chatId, content, userName);
  //Adiciona a nova mensagem criada dentro do array de mensagens.
